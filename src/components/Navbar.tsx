    ...
    <nav className="text-gray-600 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
          <Link href={''} className="mr-5 hover:text-gray-900">Startups</Link>
          <Link href={''} className="mr-5 hover:text-gray-900">Tech</Link>
          <Link href={''} className="mr-5 hover:text-gray-900">Business</Link>
          <Link href={''} className="hover:text-gray-900">Sports</Link>
        </nav>
